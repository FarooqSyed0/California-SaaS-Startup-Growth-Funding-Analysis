...
*Screenshot uploaded: postgresqlinstallation.png*
...
*Screenshot uploaded: tableschemadesign.png*
...
*Screenshot uploaded: datasetsourceselection.png*
...
*Screenshot uploaded: exceldataexploration.png*
...
*Screenshot uploaded: dataqualityassessment.png*
...
*Screenshot uploaded: businessquestionsdefinition.png*
...
*Screenshot uploaded: importsuccess.png*
...
*Screenshot uploaded: sqlvalidation.png*
...
*Screenshot uploaded: businessqueries.png*
...
*Screenshot uploaded: pythoncleaninganalysis.png*
...
*Screenshots uploaded: employeegrowthdistribution.png, growthvsfunding.png*
...
*Screenshot uploaded: jupytersetup.png*
...
*Screenshot uploaded: vscode-extensions-list.jpg*
...
*Screenshot uploaded: githubrepo.png*
...
*Screenshot uploaded: dashboardwireframe.png*
...
*Screenshot uploaded: tableauconnection.png*
...
*Screenshot uploaded: tableaucharts.png*
...
*Screenshot uploaded: tableaudashboard.png*
...
*Screenshot uploaded: tableaupublicpublish.png*
...
|-----------------------------------------|----------------------------------------|
| Business queries                        | businessqueries.png                    |
| Business questions definition           | businessquestionsdefinition.png        |
| Dashboard wireframe                     | dashboardwireframe.png                 |
| Data quality assessment                 | dataqualityassessment.png              |
| Dataset source selection                | datasetsourceselection.png             |
| Employee growth distribution            | employeegrowthdistribution.png         |
| Excel data exploration                  | exceldataexploration.png               |
| GitHub repo                             | githubrepo.png                         |
| Growth vs Funding                       | growthvsfunding.png                    |
| Import success                          | importsuccess.png                      |
| Jupyter setup                           | jupytersetup.png                       |
| Portfolio prep                          | portfolioprep.png                      |
| PostgreSQL installation                 | postgresqlinstallation.png             |
| Python cleaning analysis                | pythoncleaninganalysis.png             |
| SQL validation                          | sqlvalidation.png                      |
| Tableau connection                      | tableauconnection.png                  |
| Tableau dashboard                       | tableaudashboard.png                   |
| Tableau public publish                  | tableaupublicpublish.png               |
| Table schema design                     | tableschemadesign.png                  |
| VS Code extensions list                 | vscode-extensions-list.jpg             |
